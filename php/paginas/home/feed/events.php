<?php 
$sql = "SELECT * FROM site_news WHERE destaque > -1 AND cat IN (6,5,8,9) order by id desc limit 3 ";
...
if ($select->rowCount() > 0) {
	...
	echo "<div class='pad-10'>Sem eventos!</div>";
}
?>
<a href="/eventos/" class="btn-all" title="Ver mais eventos"><i class="fa fa-plus" aria-hidden="true"></i></a>